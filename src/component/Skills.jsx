...
function Skills() {
  return (
    <>
      <section id="skills" className="bg-dark text-white p-5">
        <h4 className="fst-italic fw-bold fs-4 mt-5 pt-5 text-center heading">SKILLS</h4>

        <div className="tech-list mt-5 border rounded bg-secondary">
          <div className="skill-set1 d-flex justify-content-around m-3 p-3 ">
            <img
